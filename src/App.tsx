...
const SaifSettingsView: React.FC = () => (
  ...
  <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
    <div className="space-y-4">
      <h2 className="text-5xl font-serif font-bold text-[var(--gold-primary)]">Saif Intelligence</h2>
      <p className="text-[var(--text-secondary)] text-xl font-light max-w-2xl">Refine the cognitive parameters and behavioral scripts of your lead concierge.</p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
      <div className="p-10 bg-[var(--bg-low)] rounded-[2.5rem] border border-white/5 cinematic-shadow space-y-8">
        <div className="flex items-center gap-4 text-[var(--gold-primary)]">
          ...
          <h3 className="text-xs uppercase tracking-[0.4em] font-bold">Base Personality</h3>
        </div>
        <div className="space-y-4">
          <label className="text-[10px] uppercase tracking-widest text-[var(--text-muted)] font-black">Identity Narrative</label>
          <textarea 
      ...
      <div className="p-10 bg-[var(--bg-low)] rounded-[2.5rem] border border-white/5 cinematic-shadow space-y-8">
        <div className="flex items-center gap-4 text-[var(--gold-primary)]">
          <ShieldCheck size={24} />
          <h3 className="text-xs uppercase tracking-[0.4em] font-bold">Qualification Guardrails</h3>
        </div>
        <div className="space-y-6">
          {[
            "Verify Minimum Budget of $1M",
            "Confirm Property Sector Interest",
            "Capture Primary Contact Identification",
...
const AnalyticsView: React.FC = () => (
  <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
    <div className="space-y-4">
      <h2 className="text-5xl font-serif font-bold text-[var(--gold-primary)]">Performance Matrix</h2>
      <p className="text-[var(--text-secondary)] text-xl font-light max-w-2xl">Quantitative analysis of AI interactions and lead conversion velocity.</p>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
      <div className="lg:col-span-2 p-10 bg-[var(--bg-low)] rounded-[2.5rem] border border-white/5 cinematic-shadow h-96 flex flex-col justify-center items-center text-[var(--text-muted)] gap-4">
        ...
        <p className="font-serif italic text-xl">Conversion Velocity Visualization</p>
      </div>
      <div className="space-y-12">
        <div className="p-10 bg-[var(--bg-low)] rounded-[2.5rem] border border-white/5 cinematic-shadow h-full">
          <h3 className="text-[10px] uppercase tracking-[0.3em] font-bold text-[var(--gold-primary)] mb-8">Sentiment Distribution</h3>
          <div className="space-y-6">
            {['Affirmative', 'Neutral', 'Inquisitive'].map((label, i) => (
